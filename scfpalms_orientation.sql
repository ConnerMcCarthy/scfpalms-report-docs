/* Selects information from users that have completed the Orientation course and recieved a certificate in the last week */
...
WHERE     cert.customcertid = 38 -- Certificate ID 40 is the Orientation course
