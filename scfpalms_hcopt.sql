/* Selects information from users that have completed the HCOPT course and recieved a certificate in the last week */
...
WHERE     cert.customcertid = 38 -- Certificate ID 52 is the HCOPT course
